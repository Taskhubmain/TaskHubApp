/*
  # Fix Commission Logic for Orders and Tasks

  1. Changes
    - Update release_escrow_to_freelancer function to properly handle commission rates
    - Order (заказ): Always 15% commission
    - Task (объявление) regular: 15% commission
    - Task (объявление) boosted: 25% commission

  2. Commission Logic
    - When client accepts proposal on ORDER: 15% commission
    - When client accepts proposal on REGULAR task: 15% commission
    - When client accepts proposal on BOOSTED task: 25% commission
    - is_boosted field in deals is copied from the task's is_boosted field

  3. Notes
    - Freelancer receives net amount after commission deduction
    - Platform commission is tracked separately in wallet_ledger
*/
